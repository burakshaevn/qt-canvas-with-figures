...
public:
    Figure() = default;
    Figure(Point position/*int x, int y*/, int w, int h, const QPen& pen = QPen(QColor("#7b6f5d")), const int pen_width = 3, const FigureType& figure_type = FigureType::not_defined_)
        // : x_(x)
        // , y_(y)
        : position_(position)
        , w_(w)
